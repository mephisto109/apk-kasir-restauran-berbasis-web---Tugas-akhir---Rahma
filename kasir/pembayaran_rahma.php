                    ...
                    <form action="../proses/proses_bayar_rahma.php" method="POST">
                        ...
                        <div class="section-cash-rahma" id="section-cash-rahma">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="bayar_rahma" id="input_bayar_rahma"
                                           ...
                                           min="<?= $grand_total_order_rahma ?>"
                                           oninput="hitungKembalian_rahma()">
                                </div>
                                <small class="text-muted">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="hidden" name="kembalian_rahma"
                                       id="input_kembalian_rahma" value="0">
                            </div>
                        ...
                        <div class="section-noncash-rahma" id="section-noncash-rahma">
                            ...
                            <input type="hidden" name="bayar_rahma"
                                   id="input_bayar_noncash_rahma"
                                   value="<?= $grand_total_order_rahma ?>">
                            <input type="hidden" name="kembalian_rahma"
                                   id="input_kembalian_noncash_rahma" value="0">

                        </div>

                        <!-- Tombol konfirmasi — disabled sampai metode dipilih -->
                        <button type="submit" id="btn_bayar_rahma"
                                class="btn btn-bayar-rahma w-100 py-2" disabled>
...
<script>
    ...
    function pilihMetode_rahma(metode_rahma) {
        ...
        // Reset semua kartu — hapus class active dari semuanya
        ['cash', 'qris', 'debit'].forEach(m_rahma => {
            document.getElementById('card-' + m_rahma + '-rahma')
                    .classList.remove('active-rahma');
        });

        // Aktifkan kartu yang dipilih
        document.getElementById('card-' + metode_rahma + '-rahma')
                .classList.add('active-rahma');

        // Simpan nilai metode ke hidden input
        document.getElementById('input_metode_rahma').value = metode_rahma;

        // Tampilkan/sembunyikan section yang relevan
        if (metode_rahma === 'cash') {
            // Tampilkan input cash, sembunyikan noncash
            ...
            // Reset tombol — aktif hanya kalau nominal sudah valid
            document.getElementById('btn_bayar_rahma').disabled = true;
            hitungKembalian_rahma();

        } else {
            // QRIS atau Debit — sembunyikan cash, tampilkan noncash
            ...
            // Update hint sesuai metode
            const hint_rahma = document.getElementById('hint-noncash-rahma');
            if (metode_rahma === 'qris') {
                hint_rahma.textContent = 'Arahkan pelanggan scan QR, lalu klik Konfirmasi setelah pembayaran masuk';
            } else {
                hint_rahma.textContent = 'Minta pelanggan tap / gesek kartu di mesin EDC, lalu klik Konfirmasi';
            }

            // Langsung aktifkan tombol — kasir konfirmasi setelah alat bayar digunakan
            document.getElementById('btn_bayar_rahma').disabled = false;
        }
    }
